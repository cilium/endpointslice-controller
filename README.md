...
This repository is a fork of k8s endpointslice controller pkg available [here](https://github.com/kubernetes/kubernetes/blob/v1.28.1/pkg/controller/endpointslice)
...
Apply the diff in the upstream changes:

```bash
git am 0001-endpointslice-add-changes-to-endpointslice-fork.patch
go mod tidy
go mod vendor
```
